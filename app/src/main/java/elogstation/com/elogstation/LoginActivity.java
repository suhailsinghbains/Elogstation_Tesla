...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private static final String LOGINURL = "http://54.208.49.250/api/auth";
...
//            mAuthTask.execute((Void) null);
    ...
    private class MyAsyncTask extends AsyncTask<JSONObject, Void, JSONObject> {
        ...
        protected void onPostExecute(JSONObject result) {
            ...
            TextView signinText = (TextView) findViewById(R.id.signintext);
            //IMPROPER LOGIN
            Intent intent = new Intent(LoginActivity.this, ChooseAccount.class);
            ...
            try {
                ...
                if(!result.getString("token").isEmpty()){
                    signinText.setText("Logging you in...");
                    Intent intent = new Intent(LoginActivity.this, ChooseAccount.class);
                    intent.putExtra("name", email);
                    intent.putExtra("user_id", result.getString("user_id"));
                    startActivity(intent);
                }else{
                    signinText.setText(result.toString());
                }
